...
describe('Calculator', ()=>{
  ...
  test.concurrent('add - should yield 0 if an empty array is provided', ()=>{
    // Arrange
    const nums = []
    // Act
  ...
  test.concurrent('fail - transformed to number when input is number string', ()=>{
    const value = '45'
  ...
  test.concurrent('NaN is number type', ()=>{
